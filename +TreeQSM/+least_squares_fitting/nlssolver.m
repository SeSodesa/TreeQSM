...
while iter < maxiter && ~conv && rel
    ...
    if NoWeights
        [d0, J] = TreeQSM.least_squares_fitting.func_grad_cylinder(par,P);
    else
        [d0, J] = TreeQSM.least_squares_fitting.func_grad_cylinder(par,P,weight);
    end
    ...
    if NoWeights
        d = TreeQSM.least_squares_fitting.func_grad_cylinder(par,P);
    else
        d = TreeQSM.least_squares_fitting.func_grad_cylinder(par,P,weight);
    end
